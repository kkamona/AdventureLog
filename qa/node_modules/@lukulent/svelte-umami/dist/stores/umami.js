...
export const isEnabled = writable(stored ? JSON.parse(stored).enabled : true);
// Anytime the store changes, update the local storage value.
isEnabled.subscribe((value) => typeof localStorage !== 'undefined' &&
    localStorage.setItem('umami', JSON.stringify({ enabled: value })));
/** Svelte store to keep track of the status of the Umami script. */
export const status = writable(undefined);
